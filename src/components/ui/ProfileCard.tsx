...
const DEFAULT_INNER_GRADIENT_DARK = 'linear-gradient(145deg, #0f172a 0%, #1e293b 100%)';
const DEFAULT_INNER_GRADIENT_LIGHT = 'linear-gradient(145deg, #f8fafc 0%, #e2e8f0 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--inner-gradient': innerGradient ?? (theme === 'dark' ? DEFAULT_INNER_GRADIENT_DARK : DEFAULT_INNER_GRADIENT_LIGHT),
      '--behind-glow-color': behindGlowColor ?? (theme === 'dark' ? 'rgba(59, 130, 246, 0.4)' : 'rgba(59, 130, 246, 0.15)'),
      ...
      {behindGlowEnabled && (
        <div
          ...
          style={{
            ...
            opacity: 'calc(0.8 * var(--pointer-from-center))'
          }}
        />
      )}
          ...
          style={{
            ...
            boxShadow:
              theme === 'dark' 
                ...
                : 'rgba(0, 0, 0, 0.15) calc((var(--pointer-from-left) * 10px) - 3px) calc((var(--pointer-from-top) * 20px) - 6px) 30px -10px',
            ...
            >
              <img
                ...
                style={{
                  ...
                  borderRadius: cardRadius,
                  filter: theme === 'light' ? 'drop-shadow(0 10px 20px rgba(0,0,0,0.1))' : 'none'
                }}
                onError={e => {
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      <div className={`text-sm font-medium leading-none ${theme === 'dark' ? 'text-white/90' : 'text-slate-900'}`}>@{handle}</div>
                      <div className={`text-sm leading-none ${theme === 'dark' ? 'text-white/70' : 'text-slate-500'}`}>{status}</div>
                    </div>
                  </div>
                  <button
                    className={`border rounded-lg px-4 py-3 text-xs font-semibold cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:-translate-y-px ${
                        theme === 'dark' 
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage: theme === 'dark' ? 'linear-gradient(to bottom, #fff, #6f6fbe)' : 'linear-gradient(to bottom, #0f172a, #3b82f6)',
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '14px',
                    margin: '0 auto',
                    backgroundImage: theme === 'dark' ? 'linear-gradient(to bottom, #fff, #4a4ac0)' : 'linear-gradient(to bottom, #334155, #64748b)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
