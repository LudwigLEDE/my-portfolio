    ...
    <div className="min-h-screen font-sans relative overflow-x-hidden transition-colors duration-500 bg-white dark:bg-black text-slate-900 dark:text-white selection:bg-blue-500 selection:text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
            <button 
                onClick={() => navigate(-1)}
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 dark:bg-white/5 border border-slate-800 dark:border-white/10 hover:bg-slate-800 dark:hover:bg-white/10 transition-colors backdrop-blur-md text-sm font-mono uppercase tracking-wider text-white dark:text-white"
            >
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-[2fr_1fr] gap-8">
                ...
                <div className="space-y-8">
                    <SpotlightCard className="rounded-3xl aspect-video bg-slate-50 dark:bg-black/50 flex items-center justify-center border-slate-200 dark:border-white/10">
                         <div className="text-center">
                            <Layers className="w-12 h-12 text-slate-300 dark:text-slate-600 mx-auto mb-4" />
                            <p className="text-slate-400 dark:text-slate-500 font-mono text-sm">{t.offline}</p>
                         </div>
                    </SpotlightCard>
