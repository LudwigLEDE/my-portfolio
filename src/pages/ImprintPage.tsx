          ...
          {language === 'de' ? (
            <>
              ...
              <p>
                ...
                <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">https://ec.europa.eu/consumers/odr/</a>.<br />
                Unsere E-Mail-Adresse finden Sie oben im Impressum.
              </p>

              <h2 className="text-slate-800 dark:text-slate-200">Verbraucherstreitbeilegung/Universalschlichtungsstelle</h2>
              <p>
            ...
            <>
              ...
              <h2 className="text-slate-800 dark:text-slate-200">Dispute Resolution Proceedings in front of a Consumer Arbitration Board</h2>
              <p>
