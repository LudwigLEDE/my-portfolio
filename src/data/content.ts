...
export const historyEn: WorkExperience[] = [
  ...
  },
  {
    ...
    description:
      "Intensive training in media informatics, covering Java, Adobe Creative Suite, and web technologies.",
    technologies: ["Java", "C#", "SQL", "PHP", "Adobe CC", "HTML/CSS"],
    achievements: [
      "Completed rigorous 3-year state certification",
  ...
  },
  {
    ...
    tags: ["High School"],
    description:
      "Secondary education with a focus on information and medical technology.",
...
export const historyDe: WorkExperience[] = [
  ...
  },
  {
    ...
    description:
      "Intensive Ausbildung in Medieninformatik, inklusive Java, Adobe Creative Suite und Webtechnologien.",
    technologies: ["Java", "C#", "SQL", "PHP", "Adobe CC", "HTML/CSS"],
    achievements: [
      "Abschluss der 3-jährigen staatlichen Zertifizierung",
      "Spezialisierung auf Full Stack Webentwicklung",
    ],
  },
  {
    type: "education",
    ...
    tags: ["Abitur"],
    description:
      "Sekundarschulbildung mit Schwerpunkt auf Informations- und Medizintechnik.",
